...
```bash
  TENSORIUM_MOVING_PUNCTURE_TP_NPOINTS_A=40 \
    ...
    TENSORIUM_MOVING_PUNCTURE_CFL=0.16 \
    TENSORIUM_MOVING_PUNCTURE_STEPS=5800 \
    TENSORIUM_MOVING_PUNCTURE_USE_INTERPOLATED_INIT=1 \
    TENSORIUM_MOVING_PUNCTURE_TP_CALCULATE_TARGET_MASSES=0 \
    TENSORIUM_MOVING_PUNCTURE_AUTO_CIRCULAR=0 \
    TENSORIUM_MOVING_PUNCTURE_SEPARATION=3.257 \
    TENSORIUM_MOVING_PUNCTURE_MASS1=0.483 \
    TENSORIUM_MOVING_PUNCTURE_MASS2=0.483 \
    TENSORIUM_MOVING_PUNCTURE_MOMENTUM=0.116 \
    TENSORIUM_MOVING_PUNCTURE_RADIAL_MOMENTUM=0.0 \
