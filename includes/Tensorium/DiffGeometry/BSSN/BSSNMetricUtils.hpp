...
namespace tensorium_RG {
	 ...
	 *
	 * For each spatial grid point \f$ (x, y, z) \f$, the spatial metric \f$ \gamma_{ij} \f$ is extracted from the given metric,
	 * the conformal factor \f$ \chi \f$ is computed, and the conformal metric is defined as:
	 * \f[
	 ...
	 * @return A 5D tensor with shape \f$ (N_x, N_y, N_z, 3, 3) \f$ containing \f$ \tilde{\gamma}_{ij} \f$ at each grid point
	 */
	template<typename T>
