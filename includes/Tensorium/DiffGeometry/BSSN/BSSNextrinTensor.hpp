 ...
 *
 * This file defines the class `ExtrinsicCurvature` used to compute the symmetric extrinsic curvature tensor
 * \f$ K_{ij} \f$ from the time derivative of the spatial metric and the shift vector in the BSSN decomposition.
 */
