 ...
 * from the conformal metric and its associated Christoffel symbols, as used in the BSSN formulation.
 */
	...
	template<typename T>
		class TildeGamma {
			public:
				 ...
				 * @param christoffel A 3×3×3 tensor containing the Christoffel symbols \f$ \tilde{\Gamma}^i_{jk} \f$
