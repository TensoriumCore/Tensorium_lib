...
namespace tensorium_RG {
	 ...
	 * @brief Computes the trace-free conformal extrinsic curvature tensor \f$ \tilde{A}_{ij} \f$ in the BSSN formalism.
	 *
	...
	template<typename K>
		class BSSNAtildeTensor {
			public:
				...
				/**
				 * @brief Computes \f$ \tilde{A}_{ij} \f$ from \f$ K_{ij} \f$, \f$ \gamma_{ij} \f$, and \f$ \chi \f$.
				 *
				 * \f[
