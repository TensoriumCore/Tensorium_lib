...
REGISTER_TEST("bssn.solvers.lichnerowicz_trivial",
              "SOR solver preserves flat solution when sources vanish", []() {
    tensorium_RG::BSSNGridSoA<double> grid(16, 16, 16, 4, 0.5, 0.5, 0.5);
...
REGISTER_TEST("bssn.solvers.bowen_york",
              "Binary Bowen-York initialisation keeps chi positive", []() {
    tensorium_RG::BSSNGridSoA<double> grid(20, 20, 20, 4, 0.4, 0.4, 0.4);
