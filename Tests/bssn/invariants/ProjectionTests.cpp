...
REGISTER_TEST("bssn.invariants.projection", "Projection enforces algebraic constraints", []() {
    ...
    auto before = tensorium_RG::bssn::compute_invariant_stats(grid, 4);
    ...
    auto after = tensorium_RG::bssn::compute_invariant_stats(grid, 4);
