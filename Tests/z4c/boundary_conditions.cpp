...
REGISTER_TEST("z4c.bc.outgoing_wave", "Sponge boundary damps outgoing chi pulses", []() {
    const size_t nx = 40;
    const size_t ny = 40;
    const size_t nz = 40;
    const size_t ng = 8;
    ...
    tensorium_RG::z4c::apply_halos_grid<tensorium_RG::z4c::BoundaryClamp>(clamp);
    tensorium_RG::z4c::apply_halos_grid<tensorium_RG::z4c::BoundarySponge>(sponge);
...
REGISTER_TEST("z4c.bc.by_boundary_localization",
               "Determinant drift localizes near the computational boundary", []() {
                   ...
                   const auto stats = tensorium_RG::z4c::compute_invariant_stats(grid, 1);
