...
REGISTER_TEST("z4c.constraints.gamma_source_validation",
              "Gamma-source validation on Schwarzschild initial data", []() {
                  tensorium_RG::Z4cGridSoA<double> grid(40, 40, 40, 4, 0.2, 0.2, 0.2);
                  ...
                  tensorium_RG::z4c::compute_rhs_Gamma(grid, rhs_gamma, grid.Z, grid.Theta,
                                                       params, 4);
              });
