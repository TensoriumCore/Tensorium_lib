...
REGISTER_TEST("z4c.constraints.minkowski", "Constraints vanish for Minkowski data", []() {
...
REGISTER_TEST("z4c.constraints.schwarzschild",
...
REGISTER_TEST("z4c.constraints.gamma_coherence", "Gamma constraint fails on inconsistent data",
              []() {
                  tensorium_RG::Z4cGridSoA<double> grid(24, 24, 24, 4, 0.5, 0.5, 0.5);
                  tensorium_RG::init::minkowski(grid, 0.0);
                  ...
                  tensorium_RG::z4c::assert_invariants(grid, "gamma_test", 4, tol, false);
              });

REGISTER_TEST("z4c.constraints.gamma_coherence_stepper_resync",
