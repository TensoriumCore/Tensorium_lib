...
REGISTER_TEST("z4c.constraints.tilde_gamma_symbols.validate",
                  ...
                  for (size_t i = i0; i < i1; i += 4)
                      for (size_t j = j0; j < j1; j += 4)
                          for (size_t k = k0; k < k1; k += 4) {
                              ...
                              tensorium_RG::z4c::compute_tildeGamma_symbols(grid, i, j, k,
                                                                              Gamma_vals);
                              tensorium_RG::z4c::validate_tildeGamma_symbols(grid, i, j, k,
                                                                               Gamma_vals);
                              ++samples;
                          }
