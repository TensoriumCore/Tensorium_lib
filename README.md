...
- Interpolated Two-Punctures initialization requires the external TwoPuncturesC codebase from:
  `https://bitbucket.org/bernuzzi/twopuncturesc/src/master/`
- In this repository, that external solver is expected through the local `../TwoPuncturesC` integration (with GSL) at build time:
  `git clone https://bitbucket.org/bernuzzi/twopuncturesc.git ../TwoPuncturesC`
...
Known-good no-FMR merger run:

```bash
OMP_NUM_THREADS=28 \
OMP_DYNAMIC=FALSE \
TENSORIUM_MOVING_PUNCTURE_TP_THREADS=28 \
TENSORIUM_MOVING_PUNCTURE_TP_NPOINTS_A=40 \
TENSORIUM_MOVING_PUNCTURE_TP_NPOINTS_B=40 \
TENSORIUM_MOVING_PUNCTURE_TP_NPOINTS_PHI=20 \
TENSORIUM_MOVING_PUNCTURE_TP_NEWTON_TOL=1e-10 \
TENSORIUM_MOVING_PUNCTURE_TP_NEWTON_MAXIT=5 \
TENSORIUM_MOVING_PUNCTURE_TP_EPSILON=1e-6 \
TENSORIUM_MOVING_PUNCTURE_TP_TINY=1e-8 \
TENSORIUM_MOVING_PUNCTURE_GRID_N=268 \
TENSORIUM_MOVING_PUNCTURE_BOX_LENGTH=25.0 \
TENSORIUM_MOVING_PUNCTURE_SPATIAL_ORDER=4 \
TENSORIUM_MOVING_PUNCTURE_CFL=0.19 \
TENSORIUM_MOVING_PUNCTURE_STEPS=10000 \
TENSORIUM_MOVING_PUNCTURE_USE_INTERPOLATED_INIT=1 \
TENSORIUM_MOVING_PUNCTURE_TP_CALCULATE_TARGET_MASSES=1 \
TENSORIUM_MOVING_PUNCTURE_AUTO_CIRCULAR=1 \
TENSORIUM_MOVING_PUNCTURE_SEPARATION=3.053395 \
TENSORIUM_MOVING_PUNCTURE_MASS1=0.48847892320123 \
TENSORIUM_MOVING_PUNCTURE_MASS2=0.48847892320123 \
TENSORIUM_MOVING_PUNCTURE_EVOLVE_Z=0 \
TENSORIUM_MOVING_PUNCTURE_COVARIANT_Z4=1 \
TENSORIUM_MOVING_PUNCTURE_KAPPA1=0.10 \
TENSORIUM_MOVING_PUNCTURE_KAPPA2=0.0 \
TENSORIUM_MOVING_PUNCTURE_KAPPA3=1.0 \
TENSORIUM_MOVING_PUNCTURE_KAPPA_Z=1.0 \
TENSORIUM_MOVING_PUNCTURE_SHIFT_ETA=1.0 \
TENSORIUM_MOVING_PUNCTURE_BETA_B_COEFF=0.75 \
TENSORIUM_MOVING_PUNCTURE_USE_DIRECT_SHIFT_RHS=0 \
TENSORIUM_MOVING_PUNCTURE_USE_SHIFT_ADVECTION=0 \
TENSORIUM_MOVING_PUNCTURE_SHIFT_ADVECT=0.0 \
TENSORIUM_MOVING_PUNCTURE_LAPSE_ADVECT=1.0 \
TENSORIUM_MOVING_PUNCTURE_GAMMA_DRIVER_FILTERED_RHS=0 \
TENSORIUM_MOVING_PUNCTURE_KO_SIGMA=0.10 \
TENSORIUM_MOVING_PUNCTURE_ENABLE_CAKO=0 \
TENSORIUM_MOVING_PUNCTURE_CHRISTOFFEL_LAPSE_DAMPING=0.0 \
TENSORIUM_MOVING_PUNCTURE_K_GAMMA=0.0 \
TENSORIUM_MOVING_PUNCTURE_SLOW_START_LAPSE=0 \
...
TENSORIUM_MOVING_PUNCTURE_APPLY_RHS_SOMMERFELD=1 \
TENSORIUM_MOVING_PUNCTURE_RADIATIVE_COLLAR_WIDTH=4 \
TENSORIUM_MOVING_PUNCTURE_CONSTRAINT_GUARD_CELLS=8 \
TENSORIUM_MOVING_PUNCTURE_ENABLE_FMR=0 \
...
TENSORIUM_MOVING_PUNCTURE_CONSTRAINT_EXPORT_STRIDE=25 \
TENSORIUM_MOVING_PUNCTURE_SLICE_EXPORT_STRIDE=25 \
./build/Tests/TensoriumMovingPuncture
```
